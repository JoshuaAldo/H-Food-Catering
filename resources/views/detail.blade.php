    ...
    <div class="row justify-content-center">
            <div class="card shadow" style="width: 800px; height: 100%; margin:32px;background: rgb(236, 236, 236);">
                ...
                <div class="row no-gutters">
                    <div class="col-md-1">
                        <a href="/" style="text-decoration: none;display: inline-block;padding: 8px 16px; margin: 8px;box-shadow: 6px 6px 12px #c5c5c5,
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <div class="purchase">
                                ...
                                <input type="number" name="jumlah" min="1" value="1" max="{{ $menu->stock }}" style="margin-left: 8px"> <br>
